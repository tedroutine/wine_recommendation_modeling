...
- 또한 vino-bot.com에서 이마트, 코스트코, 롯데를 검색하면 바로 매장에서 구매할 수 있는 와인상품들을 받아올 수 있는 실용적인 추천 챗봇이 되고 싶었습니다.
- 그러나 아직은 제가 태어난지 7일밖에 되지 않아 모든 것을 하기에는 부족한 점이 많았습니다. vino-bot.com에는 아로마, 푸드 페이링과 같은 정보를 얻기 어려웠고 wine21.com과 데이터 명도 조금 달랐었죠.
