...
### User Based Filtering & Item Based Filtering
    ...
    - Item Based Filtering : 선별된 와인 중 고객이 와인과 함께 먹을 음식, 선호하는 향과 가격대에서 가장 가까운(코사인 유사도 거리가 가장 가까운) 와인 추천
...
## Bammlier는 아직 완벽하진 않아요.
    ...
    - 그러므로 아직은 user based filtering에서 선별된 와인 중 무작위로 선정된 와인을 우선적으로 추천하지만 여러분의 좋아요가 쌓일 수록 여러분에게 맞는 와인을 추천해드릴거에요.
